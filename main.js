        ...
        class SecondCar {
            constructor(model, producer, year, maximumSpeed, volume) {
                this.model = model;
                this.producer = producer;
                this.year = year;
                this.maximumSpeed = maximumSpeed;
        ...
        const car2 = new SecondCar('Sens', 'Lanos', 2003, 170, 1.8);
        car2.drive();
        car2.info();
        car2.increaseMaxSpeed(50);
        car2.changeYear(2007);
        car2.addDriver({name: "kokos", age: 19});
        car2.info(); // Перевірка з водієм
        ...
        const popelArr = [
            new Cinderella('olena', 32, 21),
            new Cinderella('Tetiana', 42, 12),
            new Cinderella('Sofia', 41, 78),
            new Cinderella('Dariya', 99, 11),
            new Cinderella('Mariya', 19, 13),
            new Cinderella('Antonella', 21, 28),
            new Cinderella('Oleksandra', 78, 83),
            new Cinderella('Emma', 11, 33),
            new Cinderella('Olga', 36, 44),
            new Cinderella('Sabina', 29, 26),
        ];
        ...
        class Prince extends Human {
            ...
            findCinderella1(arr) {
                if (!this.bootSize) throw new Error('немає)')
